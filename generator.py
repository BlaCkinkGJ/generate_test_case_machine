...
SEARCH_DOMINANT = [INSERT, REMOVE, UPDATE] + [SEARCH for _ in range(3)]
REMOVE_DOMINANT = [INSERT, SEARCH, UPDATE] + [REMOVE for _ in range(3)]
INSERT_DOMINANT = [REMOVE, SEARCH, UPDATE] + [INSERT for _ in range(3)]
UPDATE_DOMINANT = [REMOVE, SEARCH, INSERT] + [UPDATE for _ in range(3)]
UNIFORM_DISTRIB = [INSERT, REMOVE, SEARCH, UPDATE]
